  ...
  const getBookingById = async (bookingId) => {
    ...
    try {
      ...
      return {
        ...
        // Pricing breakdown
        pricing: {
          rentalPrice: booking.billing?.rentalPrice || 0,
          dailyRate: booking.billing?.dailyRate || 0,
          depositAmount: booking.billing?.deposit || 0,
          remainingPayment: booking.billing?.remainingPayment || 0,
          totalPrice: booking.billing?.total || 0,
          remainingPaid: booking.billing?.finalPaymentPaid || false,
          insuranceFee: booking.billing?.insuranceFee || 0,
          depositPaid: booking.billing?.depositPaid || false,
          serviceFee: booking.billing?.serviceFee || 0,
        },
        total: booking.billing?.total || 0,
        // Status flags
        paymentExpiry: booking.paymentExpiry,
        contractSigned: booking.contractSigned,
        ...
        pickupLocation: booking.pickup.displayName,
        dropoffLocation: booking.dropoff.displayName,
