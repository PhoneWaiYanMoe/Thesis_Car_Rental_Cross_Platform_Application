      ...
      <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md">
        <div className="text-center mb-10">
          <div className="w-20 h-20 bg-[#6679C0] rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-xl">
            <img src="/images/wiz_logo.png" alt="Wiz Logo" className="w-12 h-12 object-contain" />
          </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-block bg-[#F8F9FF] rounded-xl px-6 py-4">
            <p className="text-xs text-[#717685] mb-2 font-semibold">Please enter your username and password to login.</p>
            <p className="text-xs text-[#717685] mb-2 font-semibold">'Feel the magic, with Wiz'</p>
