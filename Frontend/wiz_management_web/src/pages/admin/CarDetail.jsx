...
import { ArrowLeft, Car, User, DollarSign, Calendar, MapPin, Settings, AlertCircle } from 'lucide-react';
import ConfirmDialog from '../../components/ConfirmDialog';

export default function CarDetail({ carData, onUpdateCarStatus }) {
  const { id } = useParams();
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#131A34] mb-2">Car Not Found</h2>
          <p className="text-[#717685] mb-6">The car you're looking for doesn't exist</p>
          <button
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold text-[#131A34] mb-2">{car.name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-[#131A34] mb-4">Specifications</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="bg-[#F8F9FF] rounded-xl p-4">
                ...
                <p className="font-semibold text-[#131A34]">{car.seater} Seater</p>
              </div>
              <div className="bg-[#F8F9FF] rounded-xl p-4">
          ...
          {/* performance stats */}
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-[#131A34] mb-4">Performance</h2>
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[#F8F9FF] rounded-xl">
                <p className="text-3xl font-bold text-[#6679C0] mb-1">{car.totalRentals}</p>
                <p className="text-sm text-[#717685]">Total Rentals</p>
              </div>
              <div className="text-center p-4 bg-[#F8F9FF] rounded-xl">
                <p className="text-3xl font-bold text-[#6679C0] mb-1">★ {parseFloat(car.rating).toFixed(1)}</p>
                <p className="text-sm text-[#717685]">Rating</p>
              </div>
              <div className="text-center p-4 bg-[#F8F9FF] rounded-xl">
                <p className="text-3xl font-bold text-[#6679C0] mb-1">${car.price}</p>
        ...
        <div className="space-y-6">
          {/* owner info */}
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-[#131A34] mb-4">Owner Information</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-[#131A34]">{car.ownerName}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-[#F8F9FF] rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-[#131A34]">{car.insuranceType}</span>
              </div>
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                <span className="text-[#717685]">Availability</span>
                <span className="text-sm font-semibold text-[#6679C0]">{car.availability}</span>
              </div>
            </div>
          </div>
