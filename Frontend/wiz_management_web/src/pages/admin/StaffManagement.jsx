...
export default function StaffManagement({ staffData, onCreateStaff, onUpdateStaffStatus }) {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      ...
      stopped: { bg: 'bg-yellow-50', text: 'text-yellow-700', label: 'Suspended' },
  ...
  return (
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#131A34] mb-2">Support Staff Management</h1>
          <p className="text-[#717685]">Manage customer support team accounts</p>
        </div>
        <button
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-[#131A34]">{staff.username}</h3>
              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center gap-2 text-sm text-[#717685]">
                  <span>Email:</span>
                  <span className="text-[#131A34] font-medium">{staff.email}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-[#717685]">
                  <span>Created:</span>
      ...
      {filteredStaff.length === 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
          ...
          <p className="text-[#717685] text-lg font-medium">No staff members found</p>
          <p className="text-[#B2BCE0] text-sm mt-1">Try adjusting your search</p>
        </div>
      )}
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
            <h3 className="text-2xl font-bold text-[#131A34] mb-6">Create New Staff Account</h3>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={!newStaff.username || !newStaff.password || !newStaff.email}
      ...
      {showStatusUpdate && selectedStaff && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
            <h3 className="text-2xl font-bold text-[#131A34] mb-2">Update Staff Status</h3>
      ...
      <ConfirmDialog
        ...
        title={confirmType === 'create' ? 'Create Staff Account?' : `Change Status to ${newStatus}?`}
        message={
          confirmType === 'create'
